export const mockData = {
  hero: {
    ...
    description: "I’m a Mobile Application Developer with expertise in Native Android and cross-platform solutions. I craft scalable, high-performance apps using Flutter, Kotlin, Kotlin Multiplatform, and Swift, focusing on responsive and user-centric design. Passionate about Machine Learning and Generative AI, I strive to build innovative mobile solutions that blend cutting-edge technology with real business impact.",
    profileImage: "/assets/images/profile_picture.jpeg",
    socialLinks: [
  ...
  projects: [
    {
      ...
      description: "It is cross platform application in flutter which specially build for android and ios .It uses clean architecture and bloc state-management alongisde all industry practices which are required to build an application.It is apllication where users can create , modify or even share their blogs to another platform.",
      image: "/assets/images/blogPostCover.png",
...

    {
      ...
      description: "A lightweight photo editing application built with Kotlin and Jetpack Compose, designed to let users quickly adjust brightness, contrast, saturation, and hue of an image — and save or share it instantly.",
      image: "/assets/images/PhotoStore.png",
    ...
    },
    {
      id: 3,
      title: "Whispr",
      description: "Whispr is a minimal voice-powered To-Do list application built with Kotlin, Jetpack Compose, Clean Architecture, and Hilt (Dependency Injection).",
    ...
    },
    {
      id: 4,
      title: "Vision",
      description: "It is cross platform mobile application in flutter which uses google ML kit package in flutter which provides services like text recognition,face detection,face mesh detection,pose detection ,object detection,and also segmentation",
      image: "/assets/images/shared-vision.png",
    ...
    },
     {
      ...
      description: "An Overview of Most used architecture at Enterprise-level app development in industry which also called as layered architecture or clean-architecture",
