export const mockData = {
  hero: {
    ...
    profileImage: process.env.PUBLIC_URL + "/images/profile_picture.jpeg",
    socialLinks: [
  ...
  projects: [
    {
      ...
      image: process.env.PUBLIC_URL + "/images/blogPostCover.png",
...

    {
      ...
      image: process.env.PUBLIC_URL + "/images/PhotoStore.png",
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + "/images/Voice.jpeg",
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + "/images/shared-vision.png",
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + "/images/arch.png",
    ...
    },
    {
      ...
      description:
        "An Overview of Most used architecture at Enterprise-level app development in industry which also called as layered architecture or clean-architecture",
      image: process.env.PUBLIC_URL + "/images/bloc.png",
